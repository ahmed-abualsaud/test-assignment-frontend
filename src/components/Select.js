const Select = ({ id, text, values, onChange, validrules }) => {
    ...
    return (
        <div className="form-group row align-items-center my-4 mx-auto">
            ...
            <div className="col-6 mx-0">
                <select id={id} className="form-select form-select-lg border-dark" onClick={onChange} defaultValue="selectDefault" validrules={validrules}>
